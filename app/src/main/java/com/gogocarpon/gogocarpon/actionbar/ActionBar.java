...
package com.gogocarpon.gogocarpon.actionbar;
...
public class ActionBar extends RelativeLayout implements OnClickListener {
    ...
    public ActionBar(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs,
                R.styleable.ActionBarSimple);
        CharSequence title = a.getString(R.styleable.ActionBarSimple_titleSimple);
        if (title != null) {
            setTitle(title);
        }
        a.recycle();
    ...
    /**
     * Adds a list of {@link com.gogocarpon.gogocarpon.actionbar.ActionBar.Action}s.
    ...
    /**
     * Adds a new {@link com.gogocarpon.gogocarpon.actionbar.ActionBar.Action}.
    ...
    /**
     * Adds a new {@link com.gogocarpon.gogocarpon.actionbar.ActionBar.Action} at the specified index.
     * @param action the action to add
    ...
    /**
     * Inflates a {@link android.view.View} with the given {@link com.gogocarpon.gogocarpon.actionbar.ActionBar.Action}.
    ...
    /**
     * A {@link java.util.LinkedList} that holds a list of {@link com.gogocarpon.gogocarpon.actionbar.ActionBar.Action}s.
     */
