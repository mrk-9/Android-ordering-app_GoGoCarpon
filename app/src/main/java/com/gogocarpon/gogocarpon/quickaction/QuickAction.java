...
public class QuickAction extends QuickActionPopupWindows implements OnDismissListener {
	...
	public QuickAction(Context context) {
		...
		mTrackAnim 	= AnimationUtils.loadAnimation(context, R.anim.qa_rail);
	...
	private void setAnimationStyle(int screenWidth, int requestedX, boolean onTop) {
		...
		case ANIM_GROW_FROM_LEFT:
			mWindow.setAnimationStyle((onTop) ? R.style.Animations_PopUpQuickAction_Left : R.style.Animations_PopDownQuickAction_Left);
			break;
					
		case ANIM_GROW_FROM_RIGHT:
			mWindow.setAnimationStyle((onTop) ? R.style.Animations_PopUpQuickAction_Right : R.style.Animations_PopDownQuickAction_Right);
			break;
					
		case ANIM_GROW_FROM_CENTER:
			mWindow.setAnimationStyle((onTop) ? R.style.Animations_PopUpQuickAction_Center : R.style.Animations_PopDownQuickAction_Center);
		break;
		...
		case ANIM_AUTO:
			if (arrowPos <= screenWidth/4) {
				...
				mWindow.setAnimationStyle((onTop) ? R.style.Animations_PopDownQuickAction_Right : R.style.Animations_PopDownQuickAction_Right);
			}
